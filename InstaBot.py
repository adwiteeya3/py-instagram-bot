...
sleep(2)
webdriver.get('https://www.instagram.com/accounts/login/?hl=en')
sleep(3)
...
hashtag_list = ['instagram', 'trending', 'bhuvanbam']

prev_user_list = []  #if it's the first time you run it, use this line and comment the two below
#prev_user_list = pd.read_csv('user_log.csv', delimiter=',').iloc[:,1:2] # useful to build a user log
...
updated_user_df.to_csv('user_log.csv')
